...
<body id="kt_body" class="bg-body">
            ...
            <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative"
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        <!--begin::Logo-->
                        <a href="{{ asset('metronic/') }}/demo1/dist/index.html" class="py-9 mb-5">
                            <img alt="Logo" src="{{ asset('images') }}/pemda.png" class="h-120px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        ...
                        <!--end::Title-->
                        <!--begin::Description-->
                        <p class="fw-bold fs-2" style="color: #986923;">Discover Amazing E-Office
                    ...
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"
                        style="background-image: url({{ asset('metronic/demo1/dist/') }}/assets/media/illustrations/sketchy-1/13.png">
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-center mb-10">
                                ...
                                <div class="text-gray-400 fw-bold fs-4">New Here?
                                    <a href="{{ asset('metronic/') }}/demo1/dist/authentication/flows/aside/sign-up.html"
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="d-flex flex-stack mb-2">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Link-->
                                    <a href="{{ asset('metronic/') }}/demo1/dist/authentication/flows/aside/password-reset.html"
    ...
    <script>
        document.getElementById("kt_sign_in_submit").addEventListener("click", function() {
            // Show the spinner and change the button label
            var button = this;
            var progress = button.querySelector('.indicator-progress');
            progress.classList.remove('d-none'); // Display the progress message and spinner
            button.querySelector('.indicator-label').innerHTML =
                'Please wait...<span class="spinner-border spinner-border-sm align-middle ms-2"></span>';

            // Simulate an asynchronous operation (e.g., an AJAX request)
            setTimeout(function() {
                // Hide the spinner and restore the original button label
                progress.classList.add('d-none'); // Hide the progress message and spinner
                button.querySelector('.indicator-label').textContent = 'Continue';
            }, 2000); // Adjust the time according to your actual asynchronous operation
        });
    </script>
</body>
<!--end::Body-->
